...
public class VolumeInfo implements Parcelable
    {
        ...
        protected VolumeInfo(Parcel in) {
            ...
            in.readList(this.industryIdentifiers, (project.com.nybestsellerbooksapp.svc.model.IndustryIdentifier.class.getClassLoader()));
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeValue(subtitle == null ? "" : subtitle);
